...
create_image()
{
	...
	local version="JetHome_${JETHOME_REVISION}_Armbian_${REVISION}_${BOARD^}_${RELEASE}_${BRANCH}_${VER/-$LINUXFAMILY/}${JETHOME_CUSTOMIZATION_NAME:+_$JETHOME_CUSTOMIZATION_NAME}"
